...
public class LocatrFragment extends SupportMapFragment {
    ...
    private static final String DIALOG_PERM_RATIONALE = "DialogPermRationale";

    private static final int REQUEST_LOCATION_PERMISSIONS = 0;
    private static final int REQUEST_PERM_RATIONALE = 1;
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_PERM_RATIONALE) {
            // Permission rationale was not dismissed
